...
from vocode.streaming.action.ses_send_email import (
    AmazonSESSendEmail,
...
class ActionFactory:
    def create_action(self, action_config: ActionConfig) -> BaseAction:
        ...
        elif isinstance(action_config, AmazonSESSendEmailActionConfig):
            return AmazonSESSendEmail(action_config, should_respond=True)
